const mailTemplate = (name, email, newPassword) => {
...
body {font-family: 'Chivo', sans-serif;}
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        <td style="padding:18px 40px 0px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><span style="color: #00634a; font-size: 24px">We received a request to reset your online banking password from username <span style="color: red">${name}</span> .</span></div><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:18px 40px 10px 0px; line-height:18px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><span style="color: #00634a"><strong>Your new password is: <span style="color: red">${newPassword}</span></strong></span></div>
